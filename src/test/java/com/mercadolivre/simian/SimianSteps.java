...
public class SimianSteps extends CucumberSteps {
    ...
    public void save_humans(io.cucumber.datatable.DataTable dataTable) {
        ...
        dataTable.asLists().stream().skip(1).forEach(
            human -> {
                ...
                boolean isSimian = parseBoolean(human.get(1));
    ...
    public void ratio_calculator() {
        ...
        if (statsDTO.getCountHumanDna() == 0L) {
            ...
            final BigDecimal ratio = BigDecimal.valueOf(statsDTO.getCountMutantDna()).divide(BigDecimal.valueOf(statsDTO.getCountHumanDna()), 2, RoundingMode.HALF_UP);
